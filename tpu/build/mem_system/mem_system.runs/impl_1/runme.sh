...
HD_PWD='/home/mss464/minitpu/tpu/build/mem_system/mem_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mem_bd_wrapper.tcl -notrace
