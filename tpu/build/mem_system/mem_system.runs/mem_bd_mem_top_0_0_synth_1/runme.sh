...
HD_PWD='/home/mss464/minitpu/tpu/build/mem_system/mem_system.runs/mem_bd_mem_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_bd_mem_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_bd_mem_top_0_0.tcl
